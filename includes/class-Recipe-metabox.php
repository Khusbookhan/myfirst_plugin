	...
	class Recipe_metabox {
		...
		*/
        public function __construct() {
            ...
            add_action( "manage_recipe_posts_columns",array($this,"rj_custom_columns"));
            add_action( "manage_recipe_posts_custom_column",array($this,"rj_custom_columns_data"),10,2);
        }
        /**
